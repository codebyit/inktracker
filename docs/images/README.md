...
Drop screenshots here as PNGs using the exact filenames below (kebab-case). The manual
already references these paths. Capture at a clean window width (~1280px) on a fresh demo
